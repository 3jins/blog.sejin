...
var postsAbout = [new _models.Post({
    belongToMajor: 'About',
    belongToMinor: 'now',
    title: 'whoami_now',
...
try {
    for (var _iterator = Object.entries(postsAbout)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
